      ...
      <section className="how-get-start">
        <div className="howGet-header">
          ...
          <p>
            ...
            financial planning. From understanding your goals to creating
            tailored investment strategies, we make managing your finances easy
            and effective.
          </p>
        </div>
        ...
        <div className="how-step-wrap">
          ...
          <div className="step-box">
            <div className="step2">
              ...
              <div className="step-guide">
                ...
                <h4>Select Goals</h4>
                <p>
                  Choose your financial goals, inculding your risk tolerance and{" "}
                  expected return, to help us tailor your investment plan.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="step-box">
            <div className="step3">
              ...
              <div className="step-guide">
                ...
                <p>
                  Receive tailored advice and a recommended investment plan
          ...
          <div className="step-box">
            <div className="step4">
              ...
              <div className="step-guide">
                ...
                <p>
                  Adjust your investment options to create a plan that aligns
                  with your financial objectives and comfort level.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="step-box">
            <div className="step6">
              ...
              <div className="step-guide">
                <h6>Step-6</h6>
                <h4>Compare Portfolio with Benchmark and Other Users</h4>
                <p>
                  Compare your portfolio's performance with benchmarks and other
                  users.
                </p>
              </div>
            </div>
        ...
        <div className="step7-wrap">
          <div className="step7">
            ...
            <div className="step7-guide">
              <h6>Step-7</h6>
              <h4>Track the Portfolio and Networth</h4>
              <p>
                Stay updated by tracking your portfolio's performance and net
                worth, allowing you to make informed financial decisions and
